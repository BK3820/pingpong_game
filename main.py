...
def draw(canvas):
    ...
    if ball_pos[0] - BALL_RADIUS <= PAD_WIDTH and paddle1_posd[1] <= ball_pos[1] and paddle1_posu[1] >= ball_pos[1]:
        ...
        flag = 0
    elif ball_pos[0] + BALL_RADIUS >= WIDTH - PAD_WIDTH and paddle2_posd[1] <= ball_pos[1] and paddle2_posu[1] >= \
            ball_pos[1]:
        ball_vel[0] = -1.1 * ball_vel[0]
        ball_vel[1] = 1.1 * ball_vel[1]
        flag = 0
    ...
    if paddle1_posd[1] > 0 and paddle1_posu[1] < HEIGHT or paddle1_posd[1] == 0 and paddle1_vel < 0 or paddle1_posu[
        1] == HEIGHT and paddle1_vel > 0:
        paddle1_posd[1] -= paddle1_vel
        paddle1_posu[1] -= paddle1_vel
    if paddle2_posd[1] > 0 and paddle2_posu[1] < HEIGHT or paddle2_posd[1] == 0 and paddle2_vel < 0 or paddle2_posu[
        1] == HEIGHT and paddle2_vel > 0:
